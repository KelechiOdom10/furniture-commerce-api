    ...
    public partial class UpdateModelsAndSeedDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2021, 3, 24, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(4860), new TimeSpan(0, 0, 0, 0, 0)), "Sink into a little slice of heaven. Our modern sofas and sleepers are here to satisfy your seating senses. Available in sumptuous leather, soft velvet and a variety of other fabrics to complete your living room ensemble.", "https://images.unsplash.com/photo-1555041469-a586c61ea9bc", "Sofas", "sofas" },
                    { 2, new DateTimeOffset(new DateTime(2021, 3, 14, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(4920), new TimeSpan(0, 0, 0, 0, 0)), "Best kitchenware and accessories with functionality and a modern style.", "https://images.unsplash.com/photo-1610701596061-2ecf227e85b2", "Kitchen", "kitchen" },
                    { 3, new DateTimeOffset(new DateTime(2021, 3, 19, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(4940), new TimeSpan(0, 0, 0, 0, 0)), "Whether beautifully upholstered or baring their elegant wood frames to the world, our modern beds are so good-looking you’ll want to leave the lights on.", "https://images.unsplash.com/photo-1618773928121-c32242e63f39", "Beds", "beds" },
                    { 4, new DateTimeOffset(new DateTime(2021, 3, 21, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(4950), new TimeSpan(0, 0, 0, 0, 0)), "Quality lighting that evokes emotion.", "https://images.unsplash.com/photo-1524484485831-a92ffc0de03f", "Lighting", "lighting" },
                    { 5, new DateTimeOffset(new DateTime(2021, 3, 22, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(4960), new TimeSpan(0, 0, 0, 0, 0)), "Keep home office morale high. Whether you’re conferencing for eight or working at a power desk for one, we’ve got you covered.", "https://images.unsplash.com/photo-1533090161767-e6ffed986c88", "Office", "office" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTimeOffset(new DateTime(2021, 9, 5, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5020), new TimeSpan(0, 1, 0, 0, 0)), "https://i.pinimg.com/originals/46/8c/0a/468c0abf669104e862355303efc1b6e7.png", "Corner Sofas", "corner-sofas" },
                    { 2, 1, new DateTimeOffset(new DateTime(2021, 12, 14, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5050), new TimeSpan(0, 0, 0, 0, 0)), "https://images.dfs.co.uk/i/dfs/mya_3a_simplywoollook_steelgrey_view1?$dfs_v2_pdp_m$&fmt=auto", "3 Seater Sofas", "3-seater-sofas" },
                    { 3, 1, new DateTimeOffset(new DateTime(2021, 7, 17, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5070), new TimeSpan(0, 1, 0, 0, 0)), "https://www.lapalma.it/uploads/product/thumbnail/135/collection_webp_plus_classic_trasparente.png.webp", "Modular Sofas", "modular-sofas" },
                    { 4, 2, new DateTimeOffset(new DateTime(2021, 10, 25, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5080), new TimeSpan(0, 1, 0, 0, 0)), "https://www.lecreuset.co.uk/dw/image/v2/BDSR_PRD/on/demandware.static/-/Sites-master-catalog-LC/default/dwda0e17d9/images/hires/Full_HD_PNG/LC_20190624_ZS_PS_FS_51804000010002_001.png?sw=765&sh=575&sm=fit", "Cookware", "cookware" },
                    { 5, 2, new DateTimeOffset(new DateTime(2021, 9, 5, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5090), new TimeSpan(0, 1, 0, 0, 0)), "https://cdn.shopify.com/s/files/1/0526/4261/1399/products/1.png?v=1628686245", "Kitchen Accessories", "kitchen-accessories" },
                    { 6, 2, new DateTimeOffset(new DateTime(2021, 12, 14, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5110), new TimeSpan(0, 0, 0, 0, 0)), "http://cdn.ecommercedns.uk/files/4/228904/0/13183260/9120001338-0.png", "Tableware", "tableware" },
                    { 7, 3, new DateTimeOffset(new DateTime(2021, 7, 17, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5120), new TimeSpan(0, 1, 0, 0, 0)), "https://www.bedsofparadise.co.uk/a-bespoke-client-folders/paradise/bespoke-images/product/carnival-double-bed-frame-3727", "Double Beds", "double-beds" },
                    { 8, 3, new DateTimeOffset(new DateTime(2021, 10, 25, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5140), new TimeSpan(0, 1, 0, 0, 0)), "https://www.afs-admin.co.uk/images-product/rialto-light-grey-linen-bed-90cm-78246", "Single Beds", "single-beds" },
                    { 9, 3, new DateTimeOffset(new DateTime(2021, 9, 25, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5150), new TimeSpan(0, 1, 0, 0, 0)), "https://www.bedsofparadise.co.uk/a-bespoke-client-folders/paradise/bespoke-images/product/Bern%20Frame%20Grey.png", "King Size Beds", "king-size-beds" },
                    { 10, 4, new DateTimeOffset(new DateTime(2022, 1, 3, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5160), new TimeSpan(0, 0, 0, 0, 0)), "https://cdn.shopify.com/s/files/1/0251/5529/products/206100313_01copy_360x.png?v=1623766088", "Floor Lamps", "floor-lamps" },
                    { 11, 4, new DateTimeOffset(new DateTime(2021, 12, 24, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5180), new TimeSpan(0, 0, 0, 0, 0)), "https://res.cloudinary.com/clippings/image/upload/t_small_square/dpr_auto,f_auto,w_auto/v2/products/brooklyn-wall-light-with-tube-glass-brass-holder-brass-ring-tube-glass-industville-clippings-11324159.png", "Wall Lights", "wall-lights" },
                    { 12, 4, new DateTimeOffset(new DateTime(2021, 11, 24, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5190), new TimeSpan(0, 0, 0, 0, 0)), "https://cdn.shopify.com/s/files/1/0342/2425/products/UMAGE_packshot_2329_AsteriaUp_pearlwhite__3_4df81b09-4b79-4bdb-892b-7c5121e4c6fd_600x.png?v=1636450893", "Ceiling Lights", "ceiling-lights" },
                    { 13, 5, new DateTimeOffset(new DateTime(2021, 4, 28, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5220), new TimeSpan(0, 1, 0, 0, 0)), "https://northdecoshop.com/5910-large_default/office-chair-low-leather.jpg", "Office Chairs", "office-chairs" },
                    { 14, 5, new DateTimeOffset(new DateTime(2021, 5, 28, 18, 2, 37, 174, DateTimeKind.Unspecified).AddTicks(5230), new TimeSpan(0, 1, 0, 0, 0)), "https://cdn11.bigcommerce.com/s-a9q2mnae4u/images/stencil/1280x1280/products/987/1466/91e9720027c98bffd301fe0e816dc3e16f774a68__69715.1646422397.png?c=1&imbypass=on", "Office Desks", "office-desks" }
                });
